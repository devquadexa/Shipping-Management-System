        ...
        <div className="modal-overlay" onClick={() => {
          ...
          <div className="modal modal-large modal-scrollable" onClick={(e) => e.stopPropagation()}>
            ...
            <div className="settlement-info">
              ...
              {(selectedAssignment.status === 'Settled' || selectedAssignment.status === 'Settled/Approved' || selectedAssignment.status === 'Settled/Rejected') && (
                <>
                  <div className="info-row">
...
const ManagementSettlementSection = ({ user }) => {
  ...
  const fetchSettlements = async () => {
    setLoading(true);
    try {
      const endpoint = 'http://localhost:5000/api/cash-balance-settlements';
